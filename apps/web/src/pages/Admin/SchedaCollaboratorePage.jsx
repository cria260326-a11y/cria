...
// ─── Dati mock ─────────────────────────────────────────────────────────────────
const COLLABORATORI = {
    1: { id: 1, nome: 'Giulia', cognome: 'Rossi', email: 'giulia.rossi@cri-affitti.it', telefono: '+39 333 1111001', ruolo: 'manager', stato: 'attivo', createdAt: '2026-01-10', codiceReferente: null, datiPagamento: null },
    2: { id: 2, nome: 'Andrea', cognome: 'Marino', email: 'andrea.marino@cri-affitti.it', telefono: '+39 333 1111002', ruolo: 'manager', stato: 'attivo', createdAt: '2026-01-15', codiceReferente: null, datiPagamento: null },
    3: { id: 3, nome: 'Federica', cognome: 'Bruno', email: 'federica.bruno@cri-affitti.it', telefono: '+39 333 1111003', ruolo: 'manager', stato: 'sospeso', createdAt: '2026-02-01', codiceReferente: null, datiPagamento: null },
    4: { id: 4, nome: 'Luca', cognome: 'Verdi', email: 'luca.verdi@cri-affitti.it', telefono: '+39 347 2222001', ruolo: 'commerciale', stato: 'attivo', createdAt: '2026-01-20', codiceReferente: 'REF-001', datiPagamento: { iban: 'IT60X0542811101000000123456', intestatario: 'Luca Verdi', banca: 'Intesa Sanpaolo', partitaIva: '12345678901' } },
    5: { id: 5, nome: 'Sara', cognome: 'Galli', email: 'sara.galli@cri-affitti.it', telefono: '+39 347 2222002', ruolo: 'commerciale', stato: 'attivo', createdAt: '2026-02-05', codiceReferente: 'REF-002', datiPagamento: { iban: 'IT40Y0300203280573605681220', intestatario: 'Sara Galli', banca: 'UniCredit', partitaIva: '98765432100' } },
